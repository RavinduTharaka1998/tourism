...
/**
 * Servlet implementation class UpdateMyPackage
 */
@WebServlet("/UpdateMyPackage")
public class UpdateMyPackage extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateMyPackage() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int property = 3;
		property = tourism.UpdateMyPackage(id,pname,hname,price,cname, phone,non,noa,noc, date, charge);
		...
		if (property == 1) {
			...
			RequestDispatcher dis2 = request.getRequestDispatcher("UpdateMyPackage.jsp");
