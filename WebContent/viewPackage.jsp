   ...
   <div class = "middle">
      ...
      <div class = "middle-inner">
          <div class = "middle-details">
          	<center><h2>Our Current Tourism Packages</h2><h4>.you can Book Our package.</h4></center>
            <hr>
            <br>
            <table>
			<thead>
				...
				<tbody>
						...
						try
						{
							...
							<td><a href='AddMyPackage.jsp?id=<%=rs.getInt("idpackage")%>' class="add">Add</a></td>
							</tr>
							<%
							}
