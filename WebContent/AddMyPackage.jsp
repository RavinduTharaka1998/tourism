       ...
       <br><br>
	      <div class = "middle">
	         <br><br>
	                ...
	                <hr>
	                <br>
	                <form method = "post" action = "AddMyPackage">
	                   ...
	                   <input type = "number" name = "non" id = "non" onInput = "checkNoN()" required>
	                   <br><span id = "check_non"></span><br>
	                   
	                   <label>Number of Adults</label><br>
	                   <input type = "number" name = "noa" id = "noa" onInput = "checkNoA()" required>
	                   <br><span id = "check_noa"></span><br>
	                   
	                   
	                   <label>Number of Child</label><br>
	                   <input type = "number" name = "noc" id = "noc" onInput = "checkNoC()" required>
